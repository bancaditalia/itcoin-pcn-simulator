...
from experiments_runner import (run_all_simulations, TopologyType, RebalancingMode)
...
def setup_topology_directories() -> Tuple[Path, Path]:
    ...
    """
    topologies_dir = cloth_root_dir / f"experiments/2024_COMCOM/topologies"
...
def setup_result_directories() -> Tuple[Path, Path]:
    ...
    """
    results_dir = cloth_root_dir / f"experiments/2024_COMCOM/results"
...
def generate_topologies(cloth_root_dir: Path, topologies_dir: Path, seeds: List[int], capacities: List[float], topology_types: List[TopologyType]) -> None:
    """
...
def run_experiment_1():
    ...
    generate_topologies(cloth_root_dir, topologies_dir, seeds, capacities, topology_types)
...
def run_experiment_2():
    ...
    results = run_all_simulations(
        ...
        topology_types = topology_types,
        tpss = None,
        tps_cfgs = '/home/ubuntu/itcoin-pcn-simulator/experiments/2024_COMCOM/PCN_load.txt',
        cleanup = False
    )
